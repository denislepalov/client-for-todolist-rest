package lepdv.clientfortodolistrest;

import lepdv.clientfortodolistrest.dto.*;
import lepdv.clientfortodolistrest.entity.Role;
...
public class Constants {
    ...
    public static final Task TASK = Task.builder()
            ...
            .dateOfCreation(LocalDate.of(2023, Month.JANUARY, 1))
            .dueDate(LocalDate.of(2025, Month.JANUARY, 1))
    ...
    public static final Task TASK_2 = Task.builder()
            ...
            .dateOfCreation(LocalDate.of(2023, Month.JANUARY, 11))
            .dueDate(LocalDate.of(2025, Month.JANUARY, 11))
            .isCompleted("Not completed")
            .user(USER)
            .build();
    public static final Task TASK_3 = Task.builder()
            ...
            .dateOfCreation(LocalDate.of(2023, Month.JANUARY, 22))
            .dueDate(LocalDate.of(2025, Month.JANUARY, 22))
            .isCompleted("Not completed")
            .user(USER)
            .build();
    public static final Task TASK_4 = Task.builder()
            ...
            .dateOfCreation(LocalDate.of(2023, Month.APRIL, 1))
            .dueDate(LocalDate.of(2025, Month.APRIL, 1))
            .isCompleted("Not completed")
            .user(KATYA)
            .build();
    public static final Task TASK_5 = Task.builder()
            ...
            .dateOfCreation(LocalDate.of(2023, Month.APRIL, 11))
            .dueDate(LocalDate.of(2025, Month.APRIL, 11))
            .isCompleted("Not completed")
            .user(KATYA)
            .build();
    public static final Task TASK_6 = Task.builder()
            ...
            .dateOfCreation(LocalDate.of(2023, Month.APRIL, 22))
            .dueDate(LocalDate.of(2025, Month.APRIL, 22))
            .isCompleted("Not completed")
            .user(KATYA)
            .build();
